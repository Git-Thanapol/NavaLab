...
export const ui = {
  th: {
    ...
    'research.eyebrow': 'งานวิจัยเด่น',
    'research.heading': 'ผลงานที่กำลังผลักดันวงการทางทะเล',
    'research.viewAll': 'ดูโปรเจกต์ทั้งหมด',
    'team.eyebrow': 'สมาชิก',
    ...
    'contact.heading': 'ติดต่อ NavaLab',
    ...
    'projects.heading': 'โปรเจกต์และงานวิจัย',
  ...
  en: {
    ...
    'research.eyebrow': 'Featured research',
    'research.heading': 'Work moving the maritime field forward',
    'research.viewAll': 'View all projects',
    ...
    'contact.heading': 'Contact NavaLab',
