...
expertise:
  th:
    - ปฏิบัติการเดินเรือ
    - ธุรกิจนำเข้า-ส่งออกทางทะเล
    - ระบบสนับสนุนการตัดสินใจเดินเรือ
  en:
    - Vessel Operations
    - Maritime Import/Export Business
...
research:
  current:
    - title:
        th: การพัฒนาระบบสนับสนุนการเดินเรือที่เสนอเส้นทางหลบหลีกหลายเส้นทาง
        en: Development of a Navigation Support System Proposing Multiple Avoidance Routes
      summary:
        th: >-
          พัฒนาระบบสนับสนุนการตัดสินใจเดินเรือที่เสนอเส้นทางหลบหลีกการชนได้หลายทางเลือกให้นักเดินเรือ
          (ตีพิมพ์ใน IEEE)
        en: >-
          Developing a navigation support system that proposes multiple collision-avoidance
          route options for navigators (published in IEEE).
    - title:
        th: ระบบสนับสนุนการเดินเรือที่เสนอเส้นทางหลบหลีกหลายเส้นทางภายใต้อิทธิพลของลม
        en: Navigation Support System Suggesting Multiple Avoidance Routes with Wind Disturbance
      summary:
        th: >-
          ต่อยอดระบบสนับสนุนการเดินเรือให้พิจารณาแรงรบกวนจากลมประกอบการเสนอเส้นทางหลบหลีก
          (อยู่ระหว่างตีพิมพ์)
        en: >-
          Extends the multi-route avoidance support system to account for wind disturbance
          effects (currently in press).
    - title:
        th: ระบบสนับสนุนการตัดสินใจเดินเรือแบบหลายเกณฑ์ที่ผนวกพลศาสตร์การเคลื่อนที่ของเรือและการใช้
          น้ำมันเชื้อเพลิง
        en: Multi-Criteria Navigation Decision Support System for Ships Incorporating
          Hydrodynamic Maneuvering and Fuel Oil Consumption
      summary:
        th: >-
          พัฒนาระบบสนับสนุนการตัดสินใจเดินเรือแบบหลายเกณฑ์ โดยผนวกพลศาสตร์การเคลื่อนที่ของเรือเข้ากับ
          การใช้น้ำมันเชื้อเพลิง (อยู่ระหว่างดำเนินการ)
        en: >-
          Developing a multi-criteria ship navigation decision-support system incorporating
          hydrodynamic maneuvering and fuel oil consumption (ongoing).
  completed: []
publications: []
links:
  email: nonthacha@navalab.org
  linkedin: https://www.linkedin.com/in/nonthacha
featured: true
---
