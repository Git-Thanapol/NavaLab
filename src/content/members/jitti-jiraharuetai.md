...
research:
  current:
    - title:
        th: การจำลองเส้นทางเดินเรือด้วยแบบจำลองคณิตศาสตร์การเคลื่อนที่และระบบควบคุม
        en: Navigation Ship Route Simulation with Manoeuvring Mathematical Modeling and Control
          Systems
      summary:
        th: >-
          ศึกษาการจำลองเส้นทางเดินเรือโดยใช้แบบจำลองทางคณิตศาสตร์ของการเคลื่อนที่เรือร่วมกับระบบควบคุม
        en: >-
          Studying ship route simulation using manoeuvring mathematical models combined with
          control systems.
  completed: []
publications: []
links:
  email: jitti@navalab.org
  linkedin: https://www.linkedin.com/in/jitti-jiraharuetai-371736368/
featured: true
---
